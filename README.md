## 유니티 클라이언트 개발자 한재민입니다. 👋'
드림아이디어소프트 25.06.16 ~ 근무중

velog  : https://velog.io/@kaffu0424
</br>

### 1️⃣ 엘리멘탈 드래곤 디펜스 ( Elemental Dragon Defense )
: 랜덤성과 속성 전략을 결합한 모바일 타워 디펜스 게임입니다. <br>
매 라운드마다 등장하는 무작위 타워와 속성 조합, <br> 
속성 간 상성, 합성 시스템, 보스 웨이브 등의 전략 요소를 통해 <br>
짧은 시간 안에 깊은 몰입과 중독성을 경험할 수 있는 캐주얼 게임입니다. <br>
**스파르타 내일배움캠프 최종 프로젝트 작품** <br>
기발 기간 : 2025.04 ~ 2024.06 <br>
팀 구성 : 개발 4 / 기획 1
...
#### 👉 ECT
Repository  : [Organization ReadMe](https://github.com/on-the-17floor)
...
### 2️⃣ Space-Mayhem
: 우주를 떠돌며 우주쓰레기/자원을 모아 생존하는 게임입니다. <br>
캡스톤 디자인 작품<br>
...
: The Binding of Isscac 모작 프로젝트 입니다. <br>
미니프로젝트 수업 팀프로젝트 과제<br>
